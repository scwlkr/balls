export interface paths {
    ...
    get: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json": components["schemas"]["RevitServerSetupStatusResponse"];
          };
        };
      };
    };
  ...
  "/browser/v1/revit-server/setup/begin": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json": components["schemas"]["BeginRevitServerSetupRequest"];
        };
      };
      responses: {
        /** @description OK */
  ...
  "/browser/v1/circles/{circleId}/files/grant/preview": {
    ...
    post: {
      ...
      requestBody: {
        content: {
          "application/json": components["schemas"]["PreviewBrowserCircleFilesGrantRequest"];
        };
      };
      responses: {
        /** @description OK */
        200: {
          ...
          content: {
            "application/json": components["schemas"]["BrowserCircleFilesGrantPreviewResponse"];
          };
        };
        /** @description Bad Request */
        400: {
    ...
    post: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json": components["schemas"]["BrowserCircleFilesGrantApplyResponse"];
          };
        };
        /** @description Bad Request */
        400: {
    ...
    post: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json": components["schemas"]["BrowserCircleFilesOpenResponse"];
          };
        };
        /** @description Bad Request */
        400: {
...
export interface components {
  schemas: {
    ...
    BrowserCircleFilesGrantApplyResponse: {
      status: string;
      folderName: string;
      memberName: string;
      access: string;
    ...
    BrowserCircleFilesGrantPreviewResponse: {
      folderName: string;
      folderPath: string;
      memberName: string;
      access: string;
    ...
    BrowserCircleFilesOpenResponse: {
      status: string;
      folderName: string;
      message: string;
    };
    ...
    PreviewBrowserCircleFilesGrantRequest: {
      folderName: string;
      memberName: string;
      access: string;
    };
    ...
    RevitServerSetupStatusResponse: {
      stage: string;
      summary: string;
