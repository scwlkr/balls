...
- [`pilots/2026-08-25-two-laptop-lan-files.md`](pilots/2026-08-25-two-laptop-lan-files.md) — checkpointed owner-run two-Windows-laptop Circle Files pilot using the exact accepted Canary.
