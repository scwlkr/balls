...
bindings. Unmap uses `force=false` and removes only a matching drive, friendly label, and exact
credential; changed or open resources are preserved with a collision error.
