...
Cross-platform Node and Web UI is published. `0.3.0-alpha.1` Trusted Circle passed exact
protected-main artifact verification and awaits explicit owner acceptance.**
...
The `0.3.0-alpha.1` candidate is not tagged or published. Its exact artifacts passed independent
Windows/Linux and shared two-Node verification; the owner decision status is recorded in the
