...
public sealed class DaemonStatusTests
{
    ...
    public async Task OpenApi_describes_the_versioned_local_control_routes()
    {
        ...
        StringAssert.Contains(document, BrowserRoutes.RevitServerSetupHandoff);
        ...
        StringAssert.Contains(document, nameof(RevitServerHandoffExportResponse));
        StringAssert.Contains(
            document,
        ...
        StringAssert.Contains(document, nameof(CreateCircleFilesContributionRequest));
