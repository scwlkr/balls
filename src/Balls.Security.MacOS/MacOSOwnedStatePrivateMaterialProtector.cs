...
namespace Balls.Security.MacOS;

[SupportedOSPlatform("macos")]
public sealed class MacOSOwnedStatePrivateMaterialProtector : IPrivateMaterialProtector
{
    public string Scheme => "macos-owned-state-v1";
